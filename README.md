...
Each Action specifies its own options, so it would be difficult to cover them all here. The _bees.Placeholder{}_ structure is used to pass information to and from a bee.
